<x-app-layout>
    <div class="flex flex-col items-center gap-5 w-full p-10" style="background-image: url('/img/background-comicu.jpg'); background-size: contain;">
        <div class="bg-neutral-900 p-8 rounded-lg w-full max-w-3xl">
            <h2 class="text-2xl font-bold text-center mb-3">
                Create New User
            </h2>
            <form method="post" action="{{ route('user.store') }}" class="w-full sm:w max-w-3xl">
                @csrf
