                        ...
                        <div class="p-4">
                            ...
                            <div id="image-preview" class="w-full p-6 mb-4 bg-neutral-700 border-dashed border-2 border-gray-400 rounded-lg items-center mx-auto text-center cursor-pointer">
                                <label for="upload" class="cursor-pointer">
                                    @if (isset($comic) && $comic->comic_photo)
                                        <img src="{{ asset('storage/comic-photos/' . $comic->comic_photo) }}" class="max-h-48 rounded-lg mx-auto" alt="{{ $comic->comic_name }}" />
                                    @else
                                    ...
                                    <span id="filename" class="text-gray-500 bg-gray-200 z-50">{{ isset($comic) ? $comic->comic_photo : '' }}</span>
                                </label>
                            </div>
                ...
                <div class="mb-6">
                    ...
                    <select id="selectCategoryId" name="category_id" class="bg-neutral-50 border border-neutral-300 text-neutral-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-neutral-700 dark:border-neutral-600 dark:placeholder-neutral-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        ...
                        @foreach ($categories as $category)
                            <option value="{{ $category->id }}" {{ $category->id === $comic->category_id ? 'selected' : '' }}>
