<x-app-layout>
    <div class="flex flex-col items-center gap-5 w-full p-5"
        ...
        <div class="bg-neutral-900 p-8 rounded-lg w-full max-w-3xl">
            <h2 class="text-2xl text-center mb-5 font-bold text-neutral-900 dark:text-white">
                Edit Comic
            </h2>
            <form method="post" action="{{ route('comic.update', $comic) }}" enctype="multipart/form-data"
                ...
                <div class="mb-6">
                    ...
                    <input id="synopsis" type="hidden" name="synopsis" value="{{ $comic->synopsis }}">
                    <trix-editor input="synopsis"
                        ...
                        placeholder="Enter synopsis here" required></trix-editor>
                ...
                <div class="mb-6">
                    <label for="inputAuthor"
                        class="block mb-2 text-md font-large text-neutral-900 dark:text-white">Comic Photo</label>
                    <div class="w-full mx-auto bg-neutral-700 rounded-lg shadow-md overflow-hidden items-center">
                        <div class="p-4">
                            ...
                            <div id="image-preview"
                                class="w-full p-6 mb-4 bg-neutral-700 border-dashed border-2 border-gray-400 rounded-lg items-center mx-auto text-center cursor-pointer">
                                <label for="upload" class="cursor-pointer">
                                    <div class="flex justify-center items-center pb-5">
                                    <img src="{{ asset('storage/comic-photo/'.$comic->comic_photo) }}" alt="sss" class="w-40 object-cover">
                                    </div>
                                    <h5 class="mb-2 text-xl font-bold tracking-tight text-neutral-100">Upload change picture
                                    </h5>
                                    <p class="font-normal text-sm text-neutral-300 md:px-6">Choose photo size should be
                                        less than <b class="text-gray-200">2mb</b></p>
                                    <p class="font-normal text-sm text-neutral-300 md:px-6">and should be in <b
                                            class="text-gray-200">JPG, PNG, or GIF</b> format.</p>
                            ...
                            <div class="flex items-center justify-center">
                                <div class="w-full">
                                    <label for="upload"
                                        class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full flex items-center justify-center cursor-pointer px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                        <span class="text-center">Upload Change</span>
                                    </label>
                                </div>
                            </div>
                        </div>
                ...
                <div class="mb-6">
                    ...
                    <select id="categoryId" name="category_id"
                        class="bg-neutral-50 border border-neutral-300 text-neutral-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-neutral-700 dark:border-neutral-600 dark:placeholder-neutral-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        <option value="" disabled selected>{{$comic->category->category_name}}</option>
