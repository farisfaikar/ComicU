            ...
            <form method="post" action="{{ route('comic.store') }}" enctype="multipart/form-data"
                ...
                <div class="relative mb-6">
                    ...
                    <input type="text" name="price" id="inputPrice"
                        ...
                        placeholder="Enter price comic here" required>
                </div>
                <div class="mb-6">
                            ...
                            <div id="image-preview"
                                ...
                                <label for="upload" class="cursor-pointer">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        ...
                                        class="w-8 h-8 text-neutral-100 mx-auto mb-4">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                                            d="M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5m-13.5-9L12 3m0 0l4.5 4.5M12 3v13.5" />
                                    </svg>
                                    <h5 class="mb-2 text-xl font-bold tracking-tight text-neutral-100">Upload picture
                                    </h5>
