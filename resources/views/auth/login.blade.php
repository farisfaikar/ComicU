<x-guest-layout>
    ...
    <div class="my-24 card w-100 bg-neutral-800 ">
        ...
        {{-- Logo Google --}}
        <div class="flex items-center justify-center mt-3 hover:bg-neutral-300">
            <a class="flex items-center" href="{{ route('google-login') }}">
