    ...
    <div class="flex flex-col items-center gap-5 w-full mt-10 p-5">
        ...
        <form method="post" action="{{ route('category.store') }}" enctype="multipart/form-data" class="w-full sm:w max-w-2xl">
            ...
            <div class="mb-6">
                ...
                <input id="inputcolor" name="color" rows="4" class="bg-neutral-50 border border-neutral-300 text-neutral-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-neutral-700 dark:border-neutral-600 dark:placeholder-neutral-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter color here" required>
            </div>
