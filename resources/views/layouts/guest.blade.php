...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark">
    ...
    <body class="font-sans text-neutral-900 antialiased bg-neutral-950">
        <div class="bg-amber-900  flex justify-center">
            <div class="flex items-center py-2 px-6 lg:px-8 max-w-7xl justify-between w-full">
                ...
                <div class="flex items-center gap-5">
                    ...
                    @else
                    <a href="{{ route('login') }}" class="inline-block bg-transparent hover:bg-white text-neutral-100 font-semibold hover:text-amber-700 py-2 px-4 border border-white-500 hover:border-transparent rounded focus:outline-none focus:ring focus:ring-blue-200 focus:ring-offset-neutral-100">
                        Login
                    </a>

                        @if (Route::has('register'))
                        <a href="{{ route('register') }}" class="inline-block bg-transparent hover:bg-white text-neutral-100 font-semibold hover:text-amber-700 py-2 px-4 border border-white-500 hover:border-transparent rounded">
                        Register
                    </a>
        ...
        <footer class="footer p-10 bg-amber-900 opacity-90 ">
            <nav>
        ...
        <footer class="footer px-10 py-4 border-t bg-amber-900 opacity-90 text-base-content">
            ...
            <nav class="md:place-self-center md:justify-self-end">
                <div class="grid grid-flow-col gap-4">
                    <a><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40" height="40" viewBox="0,0,256,256">
