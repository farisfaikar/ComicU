...
<body class="antialiased">
    <div class="relative min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
        @if (Route::has('login'))
            <!-- Navbar -->
            <div class="flex justify-between items-center sticky top-0 backdrop-blur-sm px-6 lg:px-8 py-4 text-right dark:bg-gray-900/50 w-full z-30">
                <!-- Logo -->
                <a href="{{ route('home') }}" class="flex items-center gap-4 hover:bg-gray-800 rounded p-2 focus:outline-red-500 focus:outline focus:outline-2">
                    <h1 class="font-semibold text-gray-600 dark:text-gray-400 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">ComicU</h1>
                </a>
                <div>
                    @auth
