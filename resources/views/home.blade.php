            ...
            <div class="relative mt-10 grid grid-cols-2 lg:grid-cols-6 sm:grid-cols-2 md:grid-cols-3 gap-10" >
                @foreach ($popu_comics as $popu_comic)
                    <div class="flex flex-col max-w-sm border rounded-lg shadow bg-neutral-900 border-neutral-800">
                        ...
                        <div class="p-5">
                            <a href="{{ url ('comic_details', $comic->id) }}" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-yellow-700 rounded-lg hover:bg-yellow-800 focus:ring-4 focus:outline-none focus:ring-yellow-300 dark:bg-yellow-600 dark:hover:bg-yellow-700 dark:focus:ring-yellow-800">
                                Read more
                                <svg class="rtl:rotate-180 w-3.5 h-3.5 ms-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9" />
